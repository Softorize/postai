...
export function ImportEnvironmentDialog({ isOpen, onClose }: ImportEnvironmentDialogProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const importResult = await importEnvironment(content)

      if (importResult.success) {
        setResult({
          success: true,
          message: `Successfully imported "${importResult.environment?.name}"`,
          details: `${importResult.variables_imported} variables imported`,
        })
        ...
        setResult({
          ...
          details: importResult.error || 'Unknown error',
        })
      }
    } catch (error: unknown) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-panel border border-border rounded-xl shadow-2xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
          <h2 className="text-lg font-semibold">Import Environment</h2>
          <button
            onClick={handleClose}
        ...
        <div className="p-6">
          ...
          >
            {file ? (
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  <p className="font-medium">Drop Postman environment here</p>
          ...
          <p className="mt-4 text-xs text-text-secondary text-center">
            Supports Postman Environment export format
          </p>
        </div>
